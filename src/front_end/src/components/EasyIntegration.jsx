    ...
    <section className="bg-gray-900 text-white py-12 md:py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 max-w-6xl mx-auto">
          {/* First Card */}
          <div className="bg-gray-800 rounded-lg p-6 md:p-8 text-center hover:bg-gray-700 transition-colors duration-200">
            ...
            <h3 className="text-lg md:text-xl font-semibold mb-4">Sign up for Sandbox instantly</h3>
          ...
          <div className="bg-gray-800 rounded-lg p-6 md:p-8 text-center hover:bg-gray-700 transition-colors duration-200">
            ...
            <h3 className="text-lg md:text-xl font-semibold mb-4">Generate your API keys</h3>
            <p className="text-gray-400 text-sm md:text-base">
              This will be a short description copy
            </p>
          </div>
          ...
          <div className="bg-gray-800 rounded-lg p-6 md:p-8 text-center hover:bg-gray-700 transition-colors duration-200">
            ...
            <h3 className="text-lg md:text-xl font-semibold mb-4">Test your first call</h3>
            <p className="text-gray-400 text-sm md:text-base">
              This will be a short description copy
            </p>
          </div>
